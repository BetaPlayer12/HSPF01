...
{
    public class SkeletonAnimationHelper : MonoBehaviour
    {
        /// <summary>
        ...
        public event Action<AnimationData> AnimationSet;
        ...
        public TrackEntry SetAnimation(int id, string name, bool loop, float mixDuration)
        {
            ...
            AnimationSet?.Invoke(new AnimationData(id, name, loop, mixDuration));
            return trackEntry;
        }
        ...
        public TrackEntry SetAnimation(int id, string name, bool loop)
        {
            ...
            AnimationSet?.Invoke(new AnimationData(id, name, loop));
